...
bulges =  {'E3':5,'E6':5} # Specific definition. Bulges are located at positions defined by the user
...
for comb in combinations:
	...
	for j,bulcomb in enumerate(bcombinations):
			...
			st = PairConstraints(h1c-2,loop6,8,3,"H1L6a") ; fileoutc.write(st);
			st = HarmonicPairConstraints(h1c-2,loop6,8,8,) ; fileout.write(st); fileoutb.write(st);
			st = HarmonicPairConstraints(h1c,loop6,8,8,) ; fileout.write(st); fileoutb.write(st);
			...
			st = PairConstraints(h1n,e3c+3,8,2,"H1E3") ; fileoutc.write(st);
			st = PairConstraints(h1c-1,loop6+2,7.7,1.5,"H1L6b") ; fileoutc.write(st);
			st = AngleConstraints(h1c-6,h1c+1,h2c,30,8,"E6H4") ; fileoutc.write(st);
			st = HarmonicPairConstraints(h1n,e3c+3,8,8) ; fileout.write(st); fileoutb.write(st);
			st = HarmonicPairConstraints(h1c-1,loop6+2,7.7,8) ; fileout.write(st); fileoutb.write(st);
