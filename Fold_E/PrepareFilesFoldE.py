...
for comb in combinations:
	...
	for j,bulcomb in enumerate(bcombinations):
			...
			AddSegmentToBlueprint(refblue = 'bp', segments = ['L10','H4'], blue0 = 'bp4', \
                                              ...
                                              hs_pairing="HSSTRIPLET 4,3-4", hh_pairing="HHPAIR 2-4.A", seg_abego={'L10':'AB'} )
			# step6
			...
			blue = Blueprint('bp5') ; blue.reindex_blueprint(start=1) # Get the global blueprint.
			...
			st = PairConstraints(H4c-1,E4c,5,2,"H4E4") ; fileout.write(st);
