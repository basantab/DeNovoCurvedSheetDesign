...
bulges =  {'E1':5,'E4':3} # Specific definition. Bulges are located at positions defined by the user
...
for comb in combinations:
	...
	for j,bulcomb in enumerate(bcombinations):
			...
			#########
			# step1
			MakeFirstBlueprint(refblue = 'bp', segments = ['E2','L6','E3'], \
					   newblue = 'bp1', ss_pairing={'E1':['E2.A']},adapt={'E3':'E2'},specific_abego={'L2':[(0,'G'),(1,'G')]})

			# step2
			AddSegmentToBlueprint(refblue = 'bp', segments = ['E1','L5'], blue0 = 'bp1', newblue='bp2', \
						      append=False, ss_pairing_shift="SSPAIR 1-2.A.1", ss_pairing={'E1':['E2.A'],'E2':['E3.A']})
			# step3
			shift = Shift(refblue = 'bp', seg1 = 'E3', seg2 = 'E2')
			AddSegmentToBlueprint(refblue = 'bp', segments = ['L7','E4'], \
					      blue0 = 'bp2', newblue='bp3', append=True, \
					      ss_pairing={'E1':['E2.A'],'E2':['E3.A'],'E3':['E4.A']},insert={'E3':shift})

			# step4
			AddSegmentToBlueprint(refblue = 'bp', segments = ['H2','L3','H3','L4'], \
					      blue0 = 'bp3', newblue='bp4', append=False, ss_pairing={'E1':['E2.A'],'E2':['E3.A'],'E3':['E4.A']}, \
					      hs_pairing='HSSTRIPLET 2,1-2',seg_abego={'L3':'BB','L4':'BA'}) # Added B to L6
			# step6
			...
			st = PairConstraints(H4c-1,E4c,6,2,"H4E4") ; fileout.write(st);
			st = PairConstraints(H4c-1,E4c,6,2,"H4E4b") ; fileout.write(st);
			#st = PairConstraints(H4c-1,E4c+3,6,2,"H4E4") ; fileout.write(st);
			print "Strand 5: %d"%(len(seg3.bp_data))
			if len(seg3.bp_data)>7:
			#st = "AmbiguousConstraint\n" ; fileout.write(st); fileoutb.write(st);
